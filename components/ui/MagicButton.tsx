...
const MagicButton = ({
  ...
  return (
        ...
        text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 
        focus:ring-offset-slate-50 gap-4 ${otherClasses}`}>
          {position === 'left' && icon}
          {title}
          {position === 'right' && icon}
        </button>   
